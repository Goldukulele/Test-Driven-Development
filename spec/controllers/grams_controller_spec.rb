...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    ...
    it "shouldn't let unauthenicated users destroy a gram" do
      gram = FactoryBot.create(:gram)
      delete :destroy, params: { id: gram.id }
  ...
  describe "grams#update action" do
    ...
    it "shouldn't let unauthenicated users to update a gram" do
      gram = FactoryBot.create(:gram)
      patch :update, params: {id: gram.id, gram: {message: "hello" } }
      expect(response).to redirect_to new_user_session_path
    end

    it "should allow users to successly update grams" do
    ...
    it "should have http 404 error if thr gram cannot be found" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#edit action" do
    ...
    it "shouldn't let unauthenicated users to edit a gram" do 
      gram = FactoryBot.create(:gram)
      get :edit, params: { id: gram.id }
      expect(response).to redirect_to new_user_session_path
    end

    it "should successly show the edit form if the gram is found" do
      gram = FactoryBot.create(:gram)
      sign_in gram.user
  ...
  describe "grams#create action" do
    ...
    it "should successfully create a new gram in our database" do
      ...
      post :create, params: {
        gram: {
          message: 'Hello!',
          picture: fixture_file_upload("/pictures.png", 'image/png')
        }
      }
